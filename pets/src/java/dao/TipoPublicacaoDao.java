    ...
    public static TipoPublicacao buscarTipo(int id) {
        ...
        try {
            ...
            if (resultado != null && resultado.next()) {
                tipoPublicacaoEntidade.setTipo(resultado.getString("tipo"));
                tipoPublicacaoEntidade.setId(resultado.getInt("id"));
            }

        } catch (SQLException ex) {
            System.err.println("Erro ao obter dados: "+TipoPublicacaoDao.class + ex.toString());
        }
